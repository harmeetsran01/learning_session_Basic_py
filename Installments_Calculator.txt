...
if temp==1:
    ...
    if amount_to_be_paid_at_intial < (0.10 * debit_amount):
        ...
        if installment_amount == (0.10 * debit_amount):
            temp_1=int(input("Press 1 to check Your Credentials and Processed... "))
            print()
            ...
            if temp_1 == 1:
                ...
                months=["January","Feburary","March","April","May","June","July","August","September","October","November","December","January","Feburary","March","April","May","June","July","August","September","October","Nomber","December","January","Feburary","March","April","May","June","July","August","September","October","November","December","January","Feburary","March","April","May","June","July","August","September","October","Nomber","December"] 
                print()
                ...
                def calculation(val,mth):
                    if val <=0 or val <=installment_amount :
                        ...
                        if mth >= 12:
                            print("Your Installments will be 0 in : ",months[mth]," ",year+1)

                        elif mth >=24:
                            print("Your Installments will be 0 in : ",months[mth]," ",year+2)
                        elif mth < 12:
                            print("Your Installments will be 0 in : ",months[mth])
                        return val
    ...
    print("Thankyou for being here! Have a Good Day...")
